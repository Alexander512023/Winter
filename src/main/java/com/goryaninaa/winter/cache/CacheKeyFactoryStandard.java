 ...
 */
public final class CacheKeyFactoryStandard implements CacheKeyFactory {

  private final Map<String, KeyExtractStrategy> cacheKeyCatalog;

  public CacheKeyFactoryStandard(final Map<String, KeyExtractStrategy> cacheKeyCatalog) {
